...
function Login() {
    ...
    const handleLogin = async (e)=>{
        ...
        setErrorMessage('');
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$public$2f$src$2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
...
// Estilos tipados con React.CSSProperties
const styles = {
    container: {
        display: 'flex',
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d601a9._.js.map