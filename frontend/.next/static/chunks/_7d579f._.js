(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7d579f._.js", {
...
function Login() {
    ...
    const handleLogin = async (e)=>{
        ...
        setErrorMessage('');
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$public$2f$src$2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
...
_s(Login, "ob/Z6+Ehfj+91olhjCJ3i/AMuFc=", false, function() {
    return [
...
//# sourceMappingURL=_7d579f._.js.map