...
function Page() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            router.replace('/dashboard'); // Evita regresar a la página de login
        } catch (error) {
...
_s(Page, "td5Zq1ylm+SBPHJKpPuvvtQfXv8=", false, function() {
    return [
...
_c = Page;
// ✅ Corrección: Definiendo los estilos como React.CSSProperties
const styles = {
    container: {
        display: 'flex',
